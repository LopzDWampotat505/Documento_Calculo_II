...
\usepackage[spanish]{babel} %Indica que escribiermos en inglés
...
\begin{figure}[H]
 \centering
 \includegraphics[width=0.3\textwidth]{Gráfica Cilindro.jpg} 
...
Asimismo, para apoyar en la visualización y demsotracion, se puede desarrollar un modelo en 3D, el cuál, mediante impresión 3D, se peude transmitir a un modelo exacto para mediciones físicas, demostrando el volumen adquirido.
\begin{figure}[H]
 \centering
